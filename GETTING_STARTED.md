...
- `--validate` (**strongly recommended**): Perform evaluation at every k (default value is 1, which can be modified like [this](configs/official/mask_rcnn_r50_fpn_1x.py#L174)) epochs during the training.
